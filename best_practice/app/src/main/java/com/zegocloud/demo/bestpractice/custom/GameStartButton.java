...
public class GameStartButton extends ZTextButton {

    public GameStartButton(@NonNull Context context) {
        super(context);
    }

    public GameStartButton(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public GameStartButton(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
